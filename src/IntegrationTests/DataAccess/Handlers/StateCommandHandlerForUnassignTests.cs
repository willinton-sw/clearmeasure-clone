...
{
    [Test]
    public async Task ShouldSaveWorkOrderBackToDraftWithNoAssignee()
    {
        ...
        var command = RemotableRequestTests.SimulateRemoteObject(new AssignedToDraftCommand(o, creator));
        ...
        order.Title.ShouldBe(o.Title);
        order.Description.ShouldBe(o.Description);
    ...
    [Test]
    public async Task ShouldSaveWorkOrderBackToDraftRemotingCommand()
    {
        new DatabaseTests().Clean();
        ...
        var command = new AssignedToDraftCommand(o, creator);
