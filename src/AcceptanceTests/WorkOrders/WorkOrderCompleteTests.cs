...
public class WorkOrderCompleteTests : AcceptanceTestBase
{
    ...
    public async Task ShouldCompleteWorkOrder()
    {
        ...
        await Expect(Page.GetByTestId(nameof(WorkOrderManage.Elements.CommandButton) + "Reopen")).ToBeVisibleAsync();
    ...
    public async Task CompleteWorkOrderWorkflow()
    {
        ...
        await Expect(Page.GetByTestId(nameof(WorkOrderManage.Elements.CommandButton) + "Reopen"))
            .ToBeVisibleAsync();
    }
}